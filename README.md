# The personal website and blog of Zachary Parsons 

[zacharyparsons.co.uk](https://zacharyparsons.co.uk)

The site includes blog posts that I have written while learning about new subjects, and projects that I have worked on either as part of tutorials or independently.


The following is the original readme file for Hylia - a fantastic lightweight starter for [Eleventy](https://11ty.io) created by [@hankchizljaw](https://twitter.com/hankchizljaw).
